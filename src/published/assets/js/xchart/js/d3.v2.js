(function() {
    ...
    d3.random = {
        normal: function(ТЕ, Я) {
            ...
            return function() {
                ...
                return ТЕ + Я * x * Math.sqrt(-2 * Math.log(r) / r);
            };
        },
        logNormal: function(ТЕ, Я) {
            var n = arguments.length;
            if (n < 2) Я = 1;
            if (n < 1) ТЕ = 0;
            var random = d3.random.normal();
            return function() {
                return Math.exp(ТЕ + Я * random());
            };
        },
    ...
    var d3_formatPrefixes = [ "y", "z", "a", "f", "p", "n", "ЮМ", "m", "", "k", "M", "G", "T", "P", "E", "Z", "Y" ].map(d3_formatPrefix);
