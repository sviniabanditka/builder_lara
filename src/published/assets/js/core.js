...
var Core =
{
    ...
    {
       /* $(document).on('click', '#modal_form_edit .close, .modal-footer button.close_button,  .modal-header button.close_button', function (e) {

         //   $('#modal_form_edit').modal("hide");
            TableBuilder.hidePreloader();
            $('.modal-backdrop').remove();
            $(this).parents('#modal_form, #modal_form_edit').hide();
